...
//implements Sendable, AutoCloseable
{
    ...
    /**
     * Allocates a PIDController_v2 with the given constants for kp, ki, and kd and a default period of
     * 0.02 seconds.
     *
     ...
     */
    public PIDController_v2(double kp, double ki, double kd) {
        this(kp, ki, kd, 0.02);
    }

    /**
     * Allocates a PIDController_v2 with the given constants for kp, ki, and kd.
     *
     * @param kp The proportional coefficient.
     * @param ki The integral coefficient.
     * @param kd The derivative coefficient.
    ...
    public PIDController_v2(double kp, double ki, double kd, double period) {
        m_kp = kp;
        m_ki = ki;
        m_kd = kd;
        ...
        instances++;
        //SendableRegistry.addLW(this, "PIDController_v2", instances);
    ...
    /**
     * Sets the setpoint for the PIDController_v2.
     *
    ...
    /**
     * Returns the current setpoint of the PIDController_v2.
     *
    ...
    //   builder.setSmartDashboardType("PIDController_v2");
